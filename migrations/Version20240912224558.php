 ...
 */
final class Version20240912224558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, login VARCHAR(32) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, communication_channel VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE subscription DROP CONSTRAINT subscription__author_id__fk');
        $this->addSql('ALTER TABLE subscription DROP CONSTRAINT subscription__follower_id__fk');
        $this->addSql('ALTER TABLE tweet DROP CONSTRAINT tweet__author_id__fk');
        $this->addSql('ALTER TABLE author_follower DROP CONSTRAINT author_follower__author_id__fk');
        $this->addSql('ALTER TABLE author_follower DROP CONSTRAINT author_follower__follower_id__fk');
